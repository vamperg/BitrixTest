...
?><nav class="pagination-container d-flex justify-content-center page-def"><?
    ...
    if($arResult["bSavePage"]):
        ...
        ?><li class="page-item"><a class="page-link" href="<?=$arResult["sUrlPath"]?><?=$strNavQueryStringFull?>"><</a></li><?
        endif;
        endif;
        else:
